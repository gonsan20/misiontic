...
def solucion():
    ...
    a = random.randint(15,30) #->[AN]Completado
    ...
    for i in range(1, a+1): #Completar #->[AN]Completado
...
def es_primo(n):
    ...
    for d in range(2, n-1): #Completar #->[AN]Completado
        ...
        if n%d == 0:#Completar #->[AN]Completado
